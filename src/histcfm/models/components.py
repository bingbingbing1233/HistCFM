"""Neural-network components derived from SydneyBioX/GHIST.

Source: https://github.com/SydneyBioX/GHIST
Modified for HistCFM on 2026-08-12 by updating package organization and
provenance documentation. Distributed under GNU GPL version 3 only; see the
repository ``LICENSE`` file. The layer definitions and initialization order
are retained from the audited GHIST-derived research source.
"""
