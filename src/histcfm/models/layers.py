"""U-Net 3+ layer helpers used by the HistCFM backbone.
...
permission is asserted. Modified for HistCFM packaging on 2026-08-12.
Distributed under GNU GPL version 3 only; see ``LICENSE`` and
``docs/licensing.md``.
"""
