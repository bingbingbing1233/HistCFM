"""U-Net 3+-style histology backbone used by HistCFM.
...
implements the U-Net 3+ architecture described in https://arxiv.org/abs/2004.08790.
No additional written permission from those upstream projects is asserted.
Modified for HistCFM packaging on 2026-08-12. Distributed under GNU GPL
version 3 only; see the repository ``LICENSE`` and ``docs/licensing.md``.
"""
